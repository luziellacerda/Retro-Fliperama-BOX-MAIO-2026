...
PKG_CMAKE_OPTS_TARGET+=" -DCMAKE_C_FLAGS=\"-O3 -march=armv8-a+crc+simd -mtune=cortex-a55 -fomit-frame-pointer\" -DCMAKE_CXX_FLAGS=\"-O3 -march=armv8-a+crc+simd -mtune=cortex-a55 -fomit-frame-pointer\""
else
